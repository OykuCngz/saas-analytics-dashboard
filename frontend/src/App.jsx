                    ...
                    <div className="flex justify-between items-center mb-6">
                       ...
                       <div className="flex gap-3">
                          <button 
                            ...
                            className="bg-slate-800 hover:bg-slate-700 text-slate-200 px-4 py-2 rounded-lg border border-slate-700 text-sm font-medium flex items-center gap-2 transition-all"
                          >
                             <Upload size={16} /> Bulk Import
                          </button>
                          <button className="bg-emerald-600 hover:bg-emerald-500 text-white px-4 py-2 rounded-lg text-sm font-semibold flex items-center gap-2 shadow-lg shadow-emerald-600/20 transition-all">
